...
impl super::interface::ModuleValueValidator for AASValidator {
    ...
    fn apply_parse_config(&mut self, _port: i32, _t: char, _data: std::sync::Arc<Vec<u8>>, _sender_comboard_config: & std::sync::mpsc::Sender<crate::comboard::imple::interface::Module_Config>,
