...
impl crate::modulestate::interface::ModuleValue for PhoneAmbientLightData {}

impl crate::modulestate::interface::ModuleValueParsable for PhoneAmbientLightData {}

impl crate::modulestate::interface::ModuleValueValidator for PALValidator {
    fn convert_to_value(
        &mut self,
