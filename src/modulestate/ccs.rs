...
use crate::protos::module::{ComputerStreamingData, ComputerStreamingConfig};
...
impl super::interface::ModuleValue for ComputerStreamingData {}

impl super::interface::ModuleValueParsable for ComputerStreamingData {}

impl super::interface::ModuleValueValidator for CCSValidator {
    ...
    fn apply_parse_config(&mut self, port: i32, _t: &str, data: std::sync::Arc<Vec<u8>>, 
		...
		let config: Box<ComputerStreamingConfig> = Box::new(ComputerStreamingConfig::parse_from_bytes(&data).map_err(|e| super::interface::ModuleError::new().message(e.to_string()))?);
    ...
    fn have_data_change(&self, _current: &Box<dyn crate::modulestate::interface::ModuleValueParsable>, _last: &Box<dyn crate::modulestate::interface::ModuleValueParsable>) -> (bool, Vec<super::alarm::model::ValueChange<f32>>) {
        return (true, vec![]);
    }
